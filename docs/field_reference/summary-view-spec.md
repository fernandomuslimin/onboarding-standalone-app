...
3. **Reconcile against existing UI** — this spec should be checked against the wizard screens already built, to catch any block/field mismatches before implementation.
