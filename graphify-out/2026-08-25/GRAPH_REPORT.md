...
## Corpus Check
- 40 files · ~73,363 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 645 nodes · 1087 edges · 35 communities (21 shown, 14 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5048fd7`
...
9. `KnowledgeCenter()` - 12 edges
10. `Step 3 — ICP (Ideal Customer Profile)` - 12 edges
...
Cohesion: 0.11
Nodes (22): BASIC_FIELDS, CHIP_FIELDS, COMPANY_TEXT_FIELDS, CompanySection(), CompanySummary(), DEEP_DIVE_FIELDS, differentiationParagraph(), LogField (+14 more)
...
Cohesion: 0.05
Nodes (53): HEADER_CELL, KnowledgeDashboard(), NUM_CELL, Row(), Tier, TIER_META, TIER_ORDER, TIER_SHARE (+45 more)
...
Cohesion: 0.12
Nodes (18): ReferenceableBase(), ReferenceableField(), ReferenceableSection(), COMPANY_SIZE_BUCKETS, FUNDING_STAGE_BUCKETS, HistorySource, ProductField, emptyIcp() (+10 more)

### Community 33 - "Community 33"
Cohesion: 0.21
Nodes (9): PersonaField, LogField, PersonaSummaryView(), PROSE, SECTION_ICON, sectionField(), sectionFieldList(), FieldValue() (+1 more)

### Community 34 - "Community 34"
Cohesion: 0.22
Nodes (9): AccordionBlock(), ConfidenceBadge(), FieldLabel(), FILLED_ICONS, firstSentence(), ICON_PATHS, LowConfidenceMark(), reviseText() (+1 more)
