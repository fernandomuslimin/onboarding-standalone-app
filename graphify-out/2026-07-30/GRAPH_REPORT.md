...
## Corpus Check
- 27 files · ~52,958 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 435 nodes · 728 edges · 22 communities (12 shown, 10 thin omitted)
...
5. `PRODUCTS` - 13 edges
6. `PERSONAS` - 12 edges
7. `IcpDetail` - 10 edges
8. `ICPS` - 10 edges
9. `PersonaDetail` - 10 edges
10. `ProductDetail` - 9 edges
...
Cohesion: 0.09
Nodes (31): CHIP_FIELDS, CompanySection(), CompanySummary(), positioningStatement(), PROSE, TEXT_FIELDS, COMPANY_CONFIDENCE, COMPANY_PROFILE (+23 more)
...
Cohesion: 0.09
Nodes (34): CampaignCombo, campaignCombosForPersona(), IcpDetail, icpsForProduct(), PersonaDetail, personaPerformance(), personasForIcp(), ProductDetail (+26 more)
