...
## Corpus Check
- 40 files · ~73,450 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 647 nodes · 1092 edges · 32 communities (18 shown, 14 thin omitted)
...
Cohesion: 0.09
Nodes (39): CampaignSection(), PerformanceRow, CAMPAIGN_COMBOS, CampaignCombo, HistoryEntityType, HistoryEntry, IcpDetail, INFRASTRUCTURE_STATUS (+31 more)
...
Cohesion: 0.06
Nodes (55): BASIC_FIELDS, CHIP_FIELDS, COMPANY_BLOCKS, COMPANY_TEXT_FIELDS, companyBlockId(), CompanySection(), CompanySummary(), DEEP_DIVE_FIELDS (+47 more)
...
Cohesion: 0.06
Nodes (38): icpsForProduct(), personasForIcp(), treeKey(), TreeNodeType, activeTransform(), boxShadowFor(), BRANCH_COLORS, CARD_TINTS (+30 more)
...
Cohesion: 0.07
Nodes (45): CHANNEL_ICON, ComboRow(), HEADER_CELL, overallFit(), STATUS_STYLE, tone(), CampaignSequenceView(), CHANNEL_ICON (+37 more)
