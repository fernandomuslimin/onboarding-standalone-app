# Graph Report - onboarding-standalone-app  (2026-08-18)

## Corpus Check
- 30 files · ~55,104 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 511 nodes · 872 edges · 25 communities (15 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `97d1ef66`
...
Cohesion: 0.19
Nodes (19): CHANNEL_ICON, ComboRow(), HEADER_CELL, overallFit(), STATUS_STYLE, tone(), CampaignSequenceView(), CHANNEL_ICON (+11 more)

### Community 2 - "Knowledge Center UI Components"
Cohesion: 0.05
Nodes (56): HEADER_CELL, KnowledgeDashboard(), NUM_CELL, PerformanceRow, Row(), Tier, TIER_META, TIER_ORDER (+48 more)
...
Cohesion: 0.08
Nodes (41): BASIC_FIELDS, CHIP_FIELDS, CompanySection(), CompanySummary(), DEEP_DIVE_FIELDS, PITCH_FIELDS, POSITIONING_FIELDS, positioningStatement() (+33 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (37): CampaignSection(), CAMPAIGN_COMBOS, COMPANY_SIZE_BUCKETS, FUNDING_STAGE_BUCKETS, HistoryEntry, INFRASTRUCTURE_STATUS, InfrastructureChannel, NAV_GROUPS (+29 more)
