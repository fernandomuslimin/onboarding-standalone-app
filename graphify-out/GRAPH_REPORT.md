# Graph Report - onboarding-standalone-app  (2026-07-30)

## Corpus Check
- 28 files · ~54,041 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 448 nodes · 762 edges · 22 communities (12 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `527a3f29`
...
5. `PRODUCTS` - 13 edges
6. `IcpDetail` - 12 edges
7. `PersonaDetail` - 12 edges
8. `PERSONAS` - 12 edges
9. `ProductDetail` - 11 edges
10. `ICPS` - 10 edges
...
Cohesion: 0.07
Nodes (60): CampaignSection(), CHANNEL_ICON, ComboRow(), HEADER_CELL, overallFit(), STATUS_STYLE, tone(), CHANNEL_ICON (+52 more)

### Community 2 - "Knowledge Center UI Components"
Cohesion: 0.09
Nodes (35): CHIP_FIELDS, CompanySection(), CompanySummary(), positioningStatement(), PROSE, TEXT_FIELDS, COMPANY_CONFIDENCE, COMPANY_PROFILE (+27 more)
...
Cohesion: 0.07
Nodes (36): HEADER_CELL, KnowledgeDashboard(), NUM_CELL, Row(), Tier, TIER_META, TIER_ORDER, TIER_SHARE (+28 more)
...
## Knowledge Gaps
- **183 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+178 more)
